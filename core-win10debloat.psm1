...
Function UpdateSettingsOOShutup10 {
...
Function DebloatAll($dryrun) {
    ...
    foreach ($Bloat in $Bloatware) {
        if ($dryrun) {
            # Write-Output "Would try to remove $Bloat. * DRY RUN ONLY!!! *"
            Get-AppxPackage -Name $Bloat
